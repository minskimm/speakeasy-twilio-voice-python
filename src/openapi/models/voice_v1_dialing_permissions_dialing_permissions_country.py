...
class VoiceV1DialingPermissionsDialingPermissionsCountryLinksTypedDict(TypedDict):
    r"""A list of URLs related to this resource."""


class VoiceV1DialingPermissionsDialingPermissionsCountryLinks(BaseModel):
    r"""A list of URLs related to this resource."""


class VoiceV1DialingPermissionsDialingPermissionsCountryTypedDict(TypedDict):
    ...
    links: NotRequired[
        Nullable[VoiceV1DialingPermissionsDialingPermissionsCountryLinksTypedDict]
    ]
    r"""A list of URLs related to this resource."""


class VoiceV1DialingPermissionsDialingPermissionsCountry(BaseModel):
    ...
    links: OptionalNullable[VoiceV1DialingPermissionsDialingPermissionsCountryLinks] = (
        UNSET
    )
    r"""A list of URLs related to this resource."""
